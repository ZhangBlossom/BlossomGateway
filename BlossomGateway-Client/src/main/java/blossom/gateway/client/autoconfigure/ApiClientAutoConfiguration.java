package blossom.gateway.client.autoconfigure;

import blossom.gateway.client.manager.DubboClientRegisterManager;
import blossom.gateway.client.manager.SpringMVCClientRegisterManager;
import blossom.gateway.client.api.ApiProperties;
